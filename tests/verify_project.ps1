...
Require-Text "scripts/game_state.gd" 'func _calculate_final_badges' "GameState must calculate completion badges"
Require-Text "scripts/game_state.gd" 'func get_run_badges_text' "GameState must expose completion badge display text"
...
Require-Text "scripts/ui/result_overlay.gd" 'get_run_badges_text' "Result overlay must display completion badges"
